function FAQ() {
  return (
    <div className="bg-gradient-to-br from-black via-red-600 to-black min-h-screen py-4 md:py-8">
      <div className="max-w-4xl mx-auto px-4 sm:px-6">
        <h1 className="text-2xl md:text-3xl font-semibold text-center text-white mb-4 md:mb-8">FAQ's</h1>

        <div className="faq-container space-y-4 md:space-y-6">
          {/* General Questions Section */}
          <div className="faq-item bg-gray-800 p-3 md:p-4 rounded-lg shadow-md">
            <h3 className="text-lg md:text-xl font-semibold text-white">General Questions</h3>
            <div className="space-y-3 md:space-y-4 mt-3 md:mt-4 text-white text-sm md:text-base">
          ...
          <div className="faq-item bg-gray-800 p-3 md:p-4 rounded-lg shadow-md">
            <h3 className="text-lg md:text-xl font-semibold text-white">Booking Process</h3>
            <div className="space-y-3 md:space-y-4 mt-3 md:mt-4 text-white text-sm md:text-base">
          ...
          <div className="faq-item bg-gray-800 p-3 md:p-4 rounded-lg shadow-md">
            <h3 className="text-lg md:text-xl font-semibold text-white">Payment and Fees</h3>
            <div className="space-y-3 md:space-y-4 mt-3 md:mt-4 text-white text-sm md:text-base">
          ...
          <div className="faq-item bg-gray-800 p-3 md:p-4 rounded-lg shadow-md">
            <h3 className="text-lg md:text-xl font-semibold text-white">During Your Stay</h3>
            <div className="space-y-3 md:space-y-4 mt-3 md:mt-4 text-white text-sm md:text-base">
          ...
          <div className="faq-item bg-gray-800 p-3 md:p-4 rounded-lg shadow-md">
            <h3 className="text-lg md:text-xl font-semibold text-white">Safety and Security</h3>
            <div className="space-y-3 md:space-y-4 mt-3 md:mt-4 text-white text-sm md:text-base">
          ...
          <div className="faq-item bg-gray-800 p-3 md:p-4 rounded-lg shadow-md">
            <h3 className="text-lg md:text-xl font-semibold text-white">Reviews and Feedback</h3>
            <div className="space-y-3 md:space-y-4 mt-3 md:mt-4 text-white text-sm md:text-base">
          ...
          <div className="faq-item bg-gray-800 p-3 md:p-4 rounded-lg shadow-md">
            <h3 className="text-lg md:text-xl font-semibold text-white">Miscellaneous</h3>
            <div className="space-y-3 md:space-y-4 mt-3 md:mt-4 text-white text-sm md:text-base">
      ...
      {/* Footer Section */}
      <footer className="bg-gray-800 text-white text-center py-3 md:py-4 mt-6 md:mt-8">
